...
clevels         = [0.02 0.04 0.06 0.08 0.1 0.15 0.2 0.25 0.3 0.4 0.5 0.6 0.7 0.8 0.9 1.0];
line_levels     = [0.05 0.1 0.2 0.3];
custom_scalar   = 1.0;
line_width      = 0.75;
...
ref_max         = 0.048143;     % max intensity of 4b — shared scale for comparison
% ╚══════════════════════════════════════════════════════════════════════════╝
...
% Normalise to 4b reference max so colorbar is on same 0-1 scale
data      = data / ref_max;
scalar    = 1;
