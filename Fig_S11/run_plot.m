...
% ╠══════════════════════════════════════════════════════════════════════════╣
% ║  Data                                                                   ║
if ~exist('data_file',   'var'), data_file   = 'integrated_data_848_852.csv'; end
if ~exist('fig_label',   'var'), fig_label   = '850 cm^{-1}';                 end
if ~exist('output_name', 'var'), output_name = 'plot_850';                    end
% ║                                                                         ║
% ║  Contour & scaling                                                      ║
...
integrated_data = readmatrix(data_file) / 4;   % normalize by integration width (246→250 = 4 steps)
