% plot_projection.m — absolute FFT projection for 4b and 5a
...
% ── Load & project 4b ────────────────────────────────────────────────────────
freq_axis_4b = readmatrix('4b/freq_axis.csv');
FFT_4b       = readmatrix('4b/FFT_magnitude.csv');
...
plot(freq_5a, proj_5a, '-',  'Color', [0 0 0],     'LineWidth', line_width, 'DisplayName', 'Later time'); hold off;
