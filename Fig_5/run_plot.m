...
% ╠══════════════════════════════════════════════════════════════════════════╣
% ║  Data                                                                   ║
if ~exist('data_file',   'var'), data_file   = 'cut_data_2950.csv'; end
if ~exist('fig_label',   'var'), fig_label   = '2950 cm^{-1}';       end
if ~exist('output_name', 'var'), output_name = 'plot_2950';           end
% ║                                                                         ║
% ║  Contour & scaling                                                      ║
